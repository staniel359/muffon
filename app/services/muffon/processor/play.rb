module Muffon
  module Processor
    ...
    private
      ...
      def profile_track
        @profile_track ||= Muffon::Processor::ProfileTrack.call(play_params)
      end
      ...
      def profile_album
        @profile_album ||= Muffon::Processor::ProfileAlbum.call(play_params)
      end
      ...
      def track_ids
        profile_album.album.track_ids |= [profile_track.track_id]
      end
    end
  end
end
